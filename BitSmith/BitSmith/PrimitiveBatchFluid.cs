...
namespace BitSmith
{
    public class PrimitiveBatchFluid : IDisposable
    {
        ...
        public PrimitiveBatchFluid(GraphicsDevice graphicsDevice)
            : this(graphicsDevice, DefaultBufferSize)
        {
        }

        public PrimitiveBatchFluid(GraphicsDevice graphicsDevice, int bufferSize)
        {
